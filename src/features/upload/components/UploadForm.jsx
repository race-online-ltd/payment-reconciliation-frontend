...
export default function UploadForm() {
  ...
  const resetAll = (resetForm) => {
    ...
    setOwnFiles([]);
    setPendingRange({ startDate: null, endDate: null });
    if (!isReprocess) setAppliedRange({ startDate: null, endDate: null });
    setResetKey((k) => k + 1);
  };

  const handleCompare = async (resetForm) => {
    try {
          ...
          return (
            <>
                  ...
                  <TextField
                    ...
                    sx={{
                      ...
                      "& .MuiOutlinedInput-root": {
                        height: 42,
                        borderRadius: 2,
                        backgroundColor: isReprocess ? "rgb(241, 245, 232)" : "#ffffff",
                        fontSize: "0.8125rem",
                        display: "flex",
                        alignItems: "center",
                        paddingLeft: "8px",
                        "& fieldset":             { borderColor: isReprocess ? "#d9f0c5" : "#e2e8f0" },
              ...
              <CompareSection
                ...
                onCompare={() => handleCompare(resetForm)}
